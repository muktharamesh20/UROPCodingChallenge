...
def main() -> None:
    ...
    with mujoco.viewer.launch_passive(
        ...
        while viewer.is_running():
            ...
            # Orientation error.
            mujoco.mju_mat2Quat(site_quat, data.site(site_id).xmat) #endefector 9x9 rotation matrix to quat
            mujoco.mju_negQuat(site_quat_conj, site_quat) #inverse of rotation??
            mujoco.mju_mulQuat(error_quat, data.mocap_quat[mocap_id], site_quat_conj) #rotation error
            mujoco.mju_quat2Vel(error_ori, error_quat, 1.0) #7x1  with axis and mag
